...
|------------|---------|------|-----|---------|------|-------|-------|
| BASE:HIHI_MSG | Hihi Alarm Message | STRING[40] | No | | No | No | No |
| BASE:HIGH_MSG | High Alarm Message | STRING[40] | No | | No | No | No |
| BASE:LOW_MSG | Low Alarm Message | STRING[40] | No | | No | No | No |
| BASE:LOLO_MSG | Lolo Alarm Message | STRING[40] | No | | No | No | No |
...
=cut
	...
	field(HIHI_ALARM_MSG,DBF_NOACCESS) {
		prompt("Hihi Alarm Message")
		special(SPC_NOMOD)
		interest(4)
		extra("char                *hihi_alarm_msg")
	}
    field(HIGH_ALARM_MSG,DBF_NOACCESS) {
		prompt("High Alarm Message")
		special(SPC_NOMOD)
		interest(4)
		extra("char                *high_alarm_msg")
	}
    field(LOLO_ALARM_MSG,DBF_NOACCESS) {
		prompt("Lolo Alarm Message")
		special(SPC_NOMOD)
		interest(4)
		extra("char                *lolo_alarm_msg")
	}
    field(LOW_ALARM_MSG,DBF_NOACCESS) {
		prompt("Low Alarm Message")
		special(SPC_NOMOD)
		interest(4)
		extra("char                *low_alarm_msg")
	}
